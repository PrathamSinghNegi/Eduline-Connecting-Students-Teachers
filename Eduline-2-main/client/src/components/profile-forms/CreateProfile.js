              ...
              <form onSubmit={(e) => onSubmit(e)}>
                ...
                <div className="form-group">
                  <input
                    ...
                    required
                  />
                  <small className="form-text text-muted">Type of work </small>
                </div>
                <div className="form-group">
                  <input
                    type="text"
                  ...
                  />
                  <small className="form-text text-muted">
                    Give us an idea of your specalization.{" "}
                  </small>
                </div>
                <div className="form-group">
                  <input
                  ...
                  />
                  <small className="form-text text-muted">
                    At which time you are available for user, mention day with
                    time.{" "}
                  </small>
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  />
                  <small className="form-text text-muted">
                    Could be your own or a portfolio website{" "}
                  </small>
                </div>
                <div className="form-group">
                  <input
                    ...
                    required
                  />
                  <small className="form-text text-muted">Location</small>
                </div>
                <div className="form-group">
                  <textarea
                    className="form-control"
