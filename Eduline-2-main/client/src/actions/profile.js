...
// Get profiles by educator id
export const getProfileById = educatorId => async dispatch => {
    try {
        const res = await axios.get(`/api/profile/educator/${educatorId}`);        
        dispatch({
